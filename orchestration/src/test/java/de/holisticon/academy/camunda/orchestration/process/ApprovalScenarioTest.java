...
public class ApprovalScenarioTest extends DualScenarioTest<ApprovalScenarioTest.GivenWhenStage, ApprovalScenarioTest.ThenStage> {
  ...
  @Disabled("TODO Please Implement this scenario!")
